...
<body>
<!-- NAVBAR -->
<nav id="p" class="navbar navbar-expand-sm navbar-light" style="position:fixed;width:100%;
	z-index:10; background-color: #34344c;padding:0px;padding-right:25px;margin:0px; border-radius:0px;">
...
<div id="demo" class="carousel slide" data-ride="carousel" style="padding:0px;margin:0px;">

  <!-- Indicators -->
  <ul class="carousel-indicators" style="padding:0px;margin:0px;text-align:center; z-index:5;width: 100%;" >
  ...
  <div class="carousel-inner" >
    <div class="carousel-item active">
      <img src="img/Londra.jpg" style="width:100%;height:500px;" alt="">
    </div>
    <div class="carousel-item">
      <img src="img/Venezia.jpg" style="width:100%;height:500px;" alt="">
    </div>
    <div class="carousel-item">
      <img src="img/Parigi.jpg" style="width:100%;height:500px;" alt="">
    </div>
     <div class="carousel-item">
      <img src="img/Mosca.jpg" style="width:100%;height:500px;" alt="">
    </div>
  </div>
...
<div id="ContenitoreAnnunci">
	...
	<div class="annuncio">
	<a href=""><img alt="" src="img/praga.jpg" width="350" height="200" oncontextmenu="return false";></a>
		<div class="nomeCitta">     
			Praga 
		</div>
		<div class="prezzo">
